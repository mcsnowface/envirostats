...
subtitle: "From Sampling Distributions to Statistical Decisions"
author: "Stefan Schreiber"
date: 10-12-2025
categories: [frequentist, inference, bayesian]

# Page image (local for the page itself)
image: pearson_fisher_neyman.png
image-alt: "When in doubt, repeat the experiment forever."

# Open Graph metadata for social media (absolute URL)
open-graph: true  # still allows Quarto defaults, but we also force tags below
...
format:
  html:
    ...
    include-in-header:
      text: |
        <!-- Forced Open Graph metadata for LinkedIn -->
        ...
        <meta property="og:image" content="https://envirostats.ca/posts/2025-10-12-understanding-frequentist-inference/pearson_fisher_neyman_1200x627.png"/>
        <meta property="og:url" content="https://envirostats.ca/posts/2025-10-12-understanding-frequentist-inference/"/>
...
---
![When in doubt, repeat the experiment forever.](pearson_fisher_neyman.png)
