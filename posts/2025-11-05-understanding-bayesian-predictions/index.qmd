...
Once you have posterior samples from $p(\theta\mid D)$, you can simulate the posterior predictive distribution $p(\tilde{y}\mid D)$ and summarize it with its mean $E[\tilde{y}\mid D]$. We’ll return to these three stages of Bayesian prediction when it becomes most helpful.
...
**Connecting this back to the three stages of Bayesian prediction:**
...
Keep the three stages of Bayesian prediction in mind and everything else becomes mechanical.
